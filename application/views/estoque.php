...
//        echo $completo;
            ...
            <div class="form-group">
                ...
                <input class="form-control" type="text" id="idforce" name="fonecedor"  required/>
                <select class="form-control" required="required" name="idforce" id="idforce">
                    <option value="" >Selecionar Fornecedor ...</option>
                    <?php foreach ($fornecedor as $fornecedor): ?>
                        <option value="<?php echo $fornecedor->idforce; ?>"><?php echo $fornecedor->nomeFornecedor; ?></option>
                    <?php endforeach ?>
                </select>
            </div>    
            <div class="form-group">
