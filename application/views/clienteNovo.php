<!DOCTYPE html>
    ...
    <?php echo form_open('clienteNovo/inserir'); ?>
        <div class="form-group">
            ...
            <input type="text" class="col-sm-5 form-control" id="nome" name="nome" required/> 
        </div>
    <div class="form-row">
        <div class="form-group col-md-3">
                <label for="cpf">CPF<h11>*</h11></label>
                <input class="col-sm-9 form-control" id="cpf" name="cpf" type="text" placeholder="Apenas números" required/>
        </div>
     <div class="form-group col-md-3">
                <label for="cnpj">CNPJ<h11>*</h11></label>
                <input class="col-sm-9 form-control" id="cnpj" name="cnpj" type="text" maxlength="18" minlength="18" placeholder="Apenas números"/>
     </div>
                <div class="form-group col-md-3">
                    <label for="dataAniver">Data de Nascimento<h11>*</h11></label>
                    <input class="col-sm-9 form-control" id="dataAniver" name="dataAniver" type="date" required maxlength="10">
                </div>          
            <div class="form-group col-md-3">
                <label for="fone">Telefone<h11>*</h11></label>
                <input class="col-sm-9 form-control" id="fone" name="fone" type="text" required maxlength="15" minlength="12"/>
            </div>
        </div>
    <div class="form-row">
                <div class="form-group col-md-3">
                    <label for="email">E-mail<h11>*</h11></label>
                    <input class="col-sm-9 form-control" id="email" name="email" type="email" placeholder="email@email.com"/>
                </div>
                <div class="form-group col-md-3">
                    <label for="contato">Contato Empresarial<h11>*</h11></label>
                    <input class="col-sm-9 form-control" id="contato" name="contato" type="text"/>
                </div>        
                <div class="form-group col-md-5">
                    <label for="endereco">Endereço<h11>*</h11></label>
                    <input type="text" class="col-sm-12 form-control" id="endereco" name="endereco" required/>
                </div>
    </div>
