    ...
    <div class="col">
        ...
        <div class="form-row">
            ...
            <div class="form-group">
                ...
                <input class="form-control" id="fone" name="fone" type="text" placeholder="(51) 999999-9999" required maxlength="15" minlength="12" value="<?php echo $clienteEditar[0]->fone; ?>"/>
            </div>
